...
def spatial_gradient(field: CenteredGrid,
    ...
    * `type=StaggeredGrid` computes the spatial_gradient at face centers of neighbouring cells
    ...
    if not scheme.is_implicit:
        ...
        if scheme.order == 22:
            values, needed_shifts = [-1/60, 9/60, -45/60, 0, 45/60, -9/60, 1/60], (-3, -2, -1, 0, 1, 2, 3)
            v_ns_b0 = [([2/60, -24/60, -35/60, 80/60, -30/60, 8/60, -1/60], (-2, -1, 0, 1, 2, 3, 4)),
                       ([-10/60, -77/60, 150/60, -100/60, 50/60, -15/60, 2/60], (-1, 0, 1, 2, 3, 4, 5)),
                       ([-147/60, 360/60, -450/60, 400/60, -225/60, 72/60, -10/60], (0, 1, 2, 3, 4, 5, 6))]
