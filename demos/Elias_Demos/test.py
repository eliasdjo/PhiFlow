...
DOMAIN = dict(extrapolation=extrapolation.PERIODIC,
              bounds=Box[0:2 * math.pi, 0:2 * math.pi], scheme=False, x=xy_num, y=xy_num)
...
velocity = StaggeredGrid(partial(tgv_pressure, vis=visc, t=0), **DOMAIN)

phi.field.spatial_gradient(pressure, type=StaggeredGrid)
