...
class TestRun:
    ...
    def adp_phi_flow(self, v, p):
        adv_diff_press = advect.semi_lagrangian(v, v, dt) - v
        adv_diff_press += diffuse.explicit(v, visc, dt) - v
        adv_diff_press -= field.spatial_gradient(p, type=self.gridtype) * dt - v
    ...
    def adp_mid_ord(self, v, p):
        adv_diff_press = advect.finite_difference(v, v, dt, scheme=Scheme(4)) - v
